...
window.OAT_CONTENT.quant = {
  ...
  questions: [
    ...
    { id:'qr73', topic:'Graphs and Charts', stem:'Quarterly sales (in $1000s) were: Q1: 40, Q2: 55, Q3: 35, Q4: 70. What percent of the year\'s total sales occurred in Q4?', options:['30%','70%','35%','17.5%'], answer:2, explanation:'<strong>Step 1:</strong> Total for the year = 40 + 55 + 35 + 70 = 200.<br><strong>Step 2:</strong> Q4 share = 70/200 = 0.35 = 35%.' },
    { id:'qr74', topic:'Graphs and Charts', stem:'A chart shows patients seen each day: Mon 12, Tue 18, Wed 9, Thu 15, Fri 21. How many more patients were seen on the busiest day than the daily average?', options:['6','21','15','9'], answer:0, explanation:'<strong>Step 1:</strong> Mean = (12+18+9+15+21)/5 = 75/5 = 15.<br><strong>Step 2:</strong> Busiest day is Friday with 21. Difference = 21 − 15 = 6.' }
  ]
};
