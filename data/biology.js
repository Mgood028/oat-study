...
window.OAT_CONTENT.biology = {
  ...
  questions: [
    ...
    { id:'bio21', topic:'Evolution', stem:'On a cladogram, what does a branch point (node) represent?', options:['The extinction of one of the lineages','The most recent common ancestor of the descendant lineages','A single specific mutation event','The present-day time point'], answer:0, explanation:'<strong>Step 1:</strong> A cladogram maps hypothesized evolutionary relationships based on shared derived traits.<br><strong>Step 2:</strong> Each node marks a hypothesized ancestral population — the most recent common ancestor — from which the branching lineages diverged.' },
